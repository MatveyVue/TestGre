<template>
  <div style="text-align: center; margin-top: 30vw;">
    ...
    <a class="click" @click="click()"><img src="https://i.postimg.cc/Bbx7rKd1/IMG-2281.png" width="450px" style="margin-left: -5vw"></a> 
  </div>
...
<script>
  import { ref } from 'vue';
      ...
      export default {
        ...
        setup() {
          const score = ref(localStorage.getItem('score') ? parseInt(localStorage.getItem('score')) : 0);
